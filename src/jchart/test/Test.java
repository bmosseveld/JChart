...
public class Test {
	...
	private JBoxChart boxChart2(boolean fixedAxis, int style) {
		...
		boxChart.chartAddDataSet("Blue 2", Color.BLUE);
		
		boxChart.chartAddDataPoint("Blue 2",-3);
		boxChart.chartAddDataPoint("Blue 2",13);
		boxChart.chartAddDataPoint("Blue 2",-13);
		boxChart.chartAddDataPoint("Blue 2",11);
		boxChart.chartAddDataPoint("Blue 2",-8);
		boxChart.chartAddDataPoint("Blue 2",12);
		boxChart.chartAddDataPoint("Blue 2",-25);
		boxChart.chartAddDataPoint("Blue 2",13);
		boxChart.chartAddDataPoint("Blue 2",-17);
		boxChart.chartAddDataPoint("Blue 2",-21);
		boxChart.chartAddDataPoint("Blue 2",-3);
		boxChart.chartAddDataPoint("Blue 2",2);
		boxChart.chartAddDataPoint("Blue 2",2);
		boxChart.chartAddDataPoint("Blue 2",-2);
		boxChart.chartAddDataPoint("Blue 2",-5);
		boxChart.chartAddDataPoint("Blue 2",13);
		boxChart.chartAddDataPoint("Blue 2",-17);
		boxChart.chartAddDataPoint("Blue 2",-17);
		boxChart.chartAddDataPoint("Blue 2",-18);
		boxChart.chartAddDataPoint("Blue 2",-5);
		boxChart.chartAddDataPoint("Blue 2",-1);
		boxChart.chartAddDataPoint("Blue 2",7);
		boxChart.chartAddDataPoint("Blue 2",19);
		boxChart.chartAddDataPoint("Blue 2",20);
		boxChart.chartAddDataPoint("Blue 2",-9);
		boxChart.chartAddDataPoint("Blue 2",-25);
		boxChart.chartAddDataPoint("Blue 2",-25);
		boxChart.chartAddDataPoint("Blue 2",-23);
		boxChart.chartAddDataPoint("Blue 2",-19);
		boxChart.chartAddDataPoint("Blue 2",-6);
		boxChart.chartAddDataPoint("Blue 2",-9);
		boxChart.chartAddDataPoint("Blue 2",-6);
		boxChart.chartAddDataPoint("Blue 2",5);
		boxChart.chartAddDataPoint("Blue 2",8);
		boxChart.chartAddDataPoint("Blue 2",-10);
		boxChart.chartAddDataPoint("Blue 2",1);
		boxChart.chartAddDataPoint("Blue 2",19);
		boxChart.chartAddDataPoint("Blue 2",14);
		boxChart.chartAddDataPoint("Blue 2",-11);
		boxChart.chartAddDataPoint("Blue 2",-10);
		boxChart.chartAddDataPoint("Blue 2",-1);
		boxChart.chartAddDataPoint("Blue 2",17);
		boxChart.chartAddDataPoint("Blue 2",16);
		boxChart.chartAddDataPoint("Blue 2",-1);
		boxChart.chartAddDataPoint("Blue 2",-11);
		boxChart.chartAddDataPoint("Blue 2",10);
		boxChart.chartAddDataPoint("Blue 2",-10);
		boxChart.chartAddDataPoint("Blue 2",0);
		boxChart.chartAddDataPoint("Blue 2",-16);
		boxChart.chartAddDataPoint("Blue 2",-25);
		boxChart.chartAddDataPoint("Blue 2",18);
		boxChart.chartAddDataPoint("Blue 2",-21);
		boxChart.chartAddDataPoint("Blue 2",16);
		boxChart.chartAddDataPoint("Blue 2",-24);
		boxChart.chartAddDataPoint("Blue 2",-21);
		boxChart.chartAddDataPoint("Blue 2",-15);
		boxChart.chartAddDataPoint("Blue 2",6);
		boxChart.chartAddDataPoint("Blue 2",5);
		boxChart.chartAddDataPoint("Blue 2",-22);
		boxChart.chartAddDataPoint("Blue 2",-7);
		boxChart.chartAddDataPoint("Blue 2",-14);
		boxChart.chartAddDataPoint("Blue 2",18);
		boxChart.chartAddDataPoint("Blue 2",-13);
		...
		boxChart.chartAddDataPoint("Blue 2",14);
		boxChart.chartAddDataPoint("Blue 2",15);
		boxChart.chartAddDataPoint("Blue 2",4);
		boxChart.chartAddDataPoint("Blue 2",-3);
		boxChart.chartAddDataPoint("Blue 2",-18);
		boxChart.chartAddDataPoint("Blue 2",-19);
		boxChart.chartAddDataPoint("Blue 2",14);
		...
		boxChart.chartAddDataSet("Red 2", Color.RED);
		
		boxChart.chartAddDataPoint("Red 2",0);
		boxChart.chartAddDataPoint("Red 2",1);
		boxChart.chartAddDataPoint("Red 2",-3);
		boxChart.chartAddDataPoint("Red 2",-5);
		boxChart.chartAddDataPoint("Red 2",-16);
		boxChart.chartAddDataPoint("Red 2",10);
		boxChart.chartAddDataPoint("Red 2",-6);
		boxChart.chartAddDataPoint("Red 2",-3);
		boxChart.chartAddDataPoint("Red 2",-3);
		boxChart.chartAddDataPoint("Red 2",-2);
		boxChart.chartAddDataPoint("Red 2",2);
		boxChart.chartAddDataPoint("Red 2",-17);
		boxChart.chartAddDataPoint("Red 2",-6);
		boxChart.chartAddDataPoint("Red 2",-9);
		boxChart.chartAddDataPoint("Red 2",-19);
		boxChart.chartAddDataPoint("Red 2",5);
		boxChart.chartAddDataPoint("Red 2",-9);
		boxChart.chartAddDataPoint("Red 2",-14);
		boxChart.chartAddDataPoint("Red 2",-17);
		boxChart.chartAddDataPoint("Red 2",0);
		boxChart.chartAddDataPoint("Red 2",-13);
		boxChart.chartAddDataPoint("Red 2",-4);
		boxChart.chartAddDataPoint("Red 2",-9);
		boxChart.chartAddDataPoint("Red 2",-7);
		boxChart.chartAddDataPoint("Red 2",-15);
		boxChart.chartAddDataPoint("Red 2",-6);
		boxChart.chartAddDataPoint("Red 2",4);
		boxChart.chartAddDataPoint("Red 2",-19);
		boxChart.chartAddDataPoint("Red 2",-16);
		boxChart.chartAddDataPoint("Red 2",3);
		boxChart.chartAddDataPoint("Red 2",-7);
		boxChart.chartAddDataPoint("Red 2",-12);
		boxChart.chartAddDataPoint("Red 2",-13);
		boxChart.chartAddDataPoint("Red 2",0);
		boxChart.chartAddDataPoint("Red 2",1);
		boxChart.chartAddDataPoint("Red 2",5);
		...
		boxChart.chartAddDataPoint("Red 2",5);
		boxChart.chartAddDataPoint("Red 2",-1);
		boxChart.chartAddDataPoint("Red 2",8);
		boxChart.chartAddDataPoint("Red 2",4);
		boxChart.chartAddDataPoint("Red 2",-6);
		boxChart.chartAddDataPoint("Red 2",-8);
		boxChart.chartAddDataPoint("Red 2",-7);
		...
		boxChart.chartAddDataPoint("Red 2",2);
		boxChart.chartAddDataPoint("Red 2",1);
		boxChart.chartAddDataPoint("Red 2",-20);
		boxChart.chartAddDataPoint("Red 2",9);
		boxChart.chartAddDataPoint("Red 2",6);
		boxChart.chartAddDataPoint("Red 2",-10);
		boxChart.chartAddDataPoint("Red 2",2);
		...
		boxChart.chartAddDataPoint("Red 2",-12);
		boxChart.chartAddDataPoint("Red 2",10);
		boxChart.chartAddDataPoint("Red 2",-18);
		boxChart.chartAddDataPoint("Red 2",2);
		boxChart.chartAddDataPoint("Red 2",3);
		boxChart.chartAddDataPoint("Red 2",-8);
		boxChart.chartAddDataPoint("Red 2",1);
		...
		boxChart.chartAddDataPoint("Red 2",1);
		boxChart.chartAddDataPoint("Red 2",3);
		boxChart.chartAddDataPoint("Red 2",-11);
		boxChart.chartAddDataPoint("Red 2",5);
		boxChart.chartAddDataPoint("Red 2",-14);
		boxChart.chartAddDataPoint("Red 2",9);
		boxChart.chartAddDataPoint("Red 2",-11);
